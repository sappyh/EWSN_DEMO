...
%
% File is renamed to ewsn-full.tex to reflect the twists made to use ewsn-proc.cls.
% 
...
%\documentclass[nocopyrightspace,10pt]{sigplan-proc-varsize-ewsn-abstract}
...
\title{Full Paper for EWSN Workshop Proceedings}
...
\begin{abstract}
This paper provides a sample of a \LaTeX\ document for EWSN Workshops. 
